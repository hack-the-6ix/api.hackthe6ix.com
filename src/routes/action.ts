...
actionRouter.put('/updateResume', isHacker, (req: Request, res: Response) => {
  logResponse(
    req,
    res,
    updateResume(req.executor!, (req as any)?.files?.resume, mongoose),
    true,
  );
});
...
actionRouter.post(
  ...
  isOrganizer,
  (req: Request, res: Response) => {
    logResponse(req, res, verifyMailingList(req.executor!), true);
  },
);
...
actionRouter.post(
  ...
  isOrganizer,
  (req: Request, res: Response) => {
    logResponse(req, res, sendAllTemplates(req.executor!), true);
  },
);
 ...
 */
actionRouter.post('/verify-otp', isOrganizer, (req: Request, res: Response) => {
  logResponse(
    req,
    res,
    verifyOTP(req.executor!, req.body.code, req.body.email),
  );
});
...
actionRouter.delete(
  ...
  isOrganizer,
  (req: Request, res: Response) => {
    logResponse(req, res, removeOTP(req.executor!, req.params.otpId));
  },
);
